#!/usr/bin/perl -w
#Download the weekly Guppy newsletter file sent to user gary@ashton-jones.com.au
#Then FTP it back to the ashton-jones.com.au/guppy directory.
#This script ought to be installed on ashton-jones.com.au machine but I don't know
#how to schedule cronjobs on it.
...
$ftp->login('ashton-jones@ashton-jones.com.au','7566bb');
